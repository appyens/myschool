# Generated by Django 2.2.13 on 2020-06-13 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='school.Address')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='school.CastCategory')),
                ('mother_tounge', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='school.Language')),
